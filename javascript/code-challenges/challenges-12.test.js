...
//^-Start
//\d - any numeric digit
//{4} - refers to length of 4
//$ - ending
//.test - literally returns T or F for regex
...
//^-Start
//[a-zA-Z] - all letters between a-z regardless of capital.
//{5,10} - refers to length of 5 to 10
//$ - ending
//.test - literally returns T or F for regex
...
//^-Start
//\w+ - match a word character 1 or more times.
//\.* - match an '.' zero or more times
//\w* - match a word character zero or more times
//@  - the @ sign
//(net|com|org) - net or com or org
//$ - ending
// /g - global
...
//^ - start
// \( - escaping the parethesis so we can continue
//\d - any numerical digit
//{3}{4} - references the length
// | - operant, but to us it just mean 'or'
//\s - white space
// "-" - technically using a special character here, but range indicator doesnt count(#cheating)
// ? - looks to match one character (so either s or '-')
