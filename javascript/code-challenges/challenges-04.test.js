...
const sortNumbers = (arr) => arr.sort( (num1, num2) => {
  return num1 - num2;
});
...
const sortBackwards = (arr) => arr.sort((num1, num2) => {
  return num2 - num1;
});
...
const sortByPrice = (arr) => arr.sort((num1, num2) => {
...
const alphabetizeBetter = (arr) => arr.sort((str1, str2) => {
  var strA = str1.toUpperCase();
  var strB = str2.toUpperCase();
...
const sortByLength = (arr) => arr.sort((str1, str2) => {
...
const sortNumbersByLength = (arr) => arr.sort((num1, num2) => {
  var numA = num1.toString().length;
  var numB = num2.toString().length;
...
const sortPeople = (arr) => arr.sort((person1, person2) =>{
  var last1 = person1.lastName.toUpperCase();
  var last2 = person2.lastName.toUpperCase();
...
const sortPeopleBetter = (arr) => arr.sort((person1, person2) => {
  var first1 = person1.firstName.toUpperCase();
  var first2 = person2.firstName.toUpperCase();
  var last1 = person1.lastName.toUpperCase();
  var last2 = person2.lastName.toUpperCase();
  var age1 = person1.age;
  var age2 = person2.age;

  return last1 === last2 && first1 === first2 ? age1 - age2 : last1 === last2 & first1 < first2 ? -1 : last1 === last2 && first1 > first2 ? 1 : last1 < last2 ? -1 : 1;
});
...
const sortMeetingsByDay = (arr) => {
  ...
  var day = { Monday: 1, Tuesday: 2, Wednesday: 3, Thursday: 4, Friday: 5, Saturday: 6, Sunday: 7};
  return arr.sort((day1, day2) =>
    day[day1.dayOfWeek] < day[day2.dayOfWeek] ? -1 : 1
  );
};
...
const sortSchedule = (arr) => arr.sort((meet1, meet2) => {

  var meetday1 = meet1.dayOfWeek;
  var meetday2 = meet2.dayOfWeek;
  var meetstart1 = meet1.start;
  var meetstart2 = meet2.start;
  var meetend1 = meet1.end;
  var meetend2 = meet2.end;

  return meetday1 === meetday2 && meetstart1 === meetstart2 && meetend1 < meetend2 ? -1 : meetday1 === meetday2 && meetstart1 === meetstart2 && meetend1 > meetend2 ? 1 : meetday1 === meetday2 && meetstart1 < meetstart2 ? -1 : 1;
